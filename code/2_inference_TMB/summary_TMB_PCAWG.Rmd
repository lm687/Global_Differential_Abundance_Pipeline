...
```{r, BoneOsteosarc_correlations_3, echo=FALSE, fig.height=2.5, fig.width=4, dev='tikz',  dependson=c('BoneOsteosarc_correlations', 'BoneOsteosarc_correlations_2')}
...
```{r, summary_convergence_SP, fig.height=4.2, fig.width=7, echo=FALSE, dependson=c('read_tmb_runs', 'load_runs_signaturesPCAWG')}
...
```{r, comparison_pvals, dependson=c('HMP_pcawg')}
...
```{r, pvals_pcawg_SP, dependson=c('p_vals_SP'), dev='tikz', fig.height=4.5, fig.width=5.5}
...
```{r, pvals_pcawg_SP_2, dependson=c('p_vals_SP')}
...
ggplot(tracksig, aes(x=-log2(pvals_diagRE_DMDL_SP_adj), y=tracksig_frac, label=ct, size=count))+geom_point()+geom_label_repel()+
