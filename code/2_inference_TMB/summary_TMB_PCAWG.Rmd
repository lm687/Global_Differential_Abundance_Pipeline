...
```{r, summary_convergence_SP, dependson=c('read_tmb_runs'), fig.height=4.2, fig.width=7, echo=FALSE, dependson=c('read_tmb_runs')}
...
```{r, minimalperturbation_diagRE_DMDL_nonexo_S}
...
```{r, minimalperturbation_diagRE_DMDL_nonexo_S_2, dependson=c('minimalperturbation_diagRE_DMDL_nonexo_S')}
...
perturbed_betas_diagRE_DMDL_nonexo_SP_df
