...
```{r, correlations_from_beta_slopes_softmax2, dependson=c('correlations_from_beta_slopes_softmax', 'names_logR_SP'), fig.height=6.5, echo=F}
...
```{r, correlations_from_beta_slopes_sigs, dependson=c('correlations_from_beta_slopes_softmax'), fig.height=7.5, echo=F}
...
ggplot(cors_softmax_melt_sigs, aes(x=factor(num_common_samples.Var1,
                              ...
                              y=factor(num_common_samples.Var2, levels=hclust_correlation_betas_sigs$labels[hclust_correlation_betas_sigs$order]),
...
```{r, correlations_from_beta_slopes_2, dependson=c('correlations_from_beta_slopes'), fig.height=6, echo=F}
aaa_dcast
```
=======
