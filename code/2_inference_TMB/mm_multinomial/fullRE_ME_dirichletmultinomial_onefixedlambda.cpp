...
Type objective_function<Type>::operator() ()
{
  ...
  PARAMETER_VECTOR(log_lambda); // log of the parameter for overdispersion in Dirichlet-Multinomial model (1 value, for the second group. The first group has a fixed overdispersion lambda of 0)
  int d_min1 = d - 1;
  ...
  log_lambdas(0) = Type(0);
  log_lambdas(1) = log_lambda(0);
