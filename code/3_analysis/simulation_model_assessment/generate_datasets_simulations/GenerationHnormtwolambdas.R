...
## Same as Generation G norm, but the standard deviations and covariances are predetermined
...
lambda = c(opt$lambda, opt$lambda/2) ## overdispersion scalars. Lower value -> higher overdispersion
...
if(sim_cov)   u = sapply(sd_RE, rnorm, n = n, mean = 0)
