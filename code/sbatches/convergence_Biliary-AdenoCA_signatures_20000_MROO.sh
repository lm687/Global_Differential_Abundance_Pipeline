#!/bin/sh
#SBATCH --job-name=Stan_Rsbatches/convergence_Biliary-AdenoCA_signatures_20000_MROO.sh
#SBATCH --out=sbatches/convergence_Biliary-AdenoCA_signatures_20000_MROO.out
