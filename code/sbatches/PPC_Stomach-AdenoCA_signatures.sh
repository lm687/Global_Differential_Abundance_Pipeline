...
Rscript --vanilla 3_analysis/posterior_predictive_checks.R --files_posteriors '../data/inference/Stomach-AdenoCA_signatures_20000_MROO.RData ../data/inference/Stomach-AdenoCA_signatures_20000_DMROO.RData ../data/inference/Stomach-AdenoCA_signatures_20000_LNMROO.RData ../data/inference/Stomach-AdenoCA_signatures_ROO.RData'
