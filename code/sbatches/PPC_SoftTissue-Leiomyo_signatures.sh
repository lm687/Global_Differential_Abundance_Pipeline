...
Rscript --vanilla 3_analysis/posterior_predictive_checks.R --files_posteriors '../data/inference/SoftTissue-Leiomyo_signatures_20000_LNMROO.RData ../data/inference/SoftTissue-Leiomyo_signatures_ROO.RData ../data/inference/SoftTissue-Leiomyo_signatures_20000_MROO.RData ../data/inference/SoftTissue-Leiomyo_signatures_20000_DMROO.RData'
