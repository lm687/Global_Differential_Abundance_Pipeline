#!/bin/sh
#SBATCH --job-name=Stan_Rsbatches/convergence_CNS-GBM_nucleotidesubstitution3_20000_DMROO.sh
#SBATCH --out=sbatches/convergence_CNS-GBM_nucleotidesubstitution3_20000_DMROO.out
