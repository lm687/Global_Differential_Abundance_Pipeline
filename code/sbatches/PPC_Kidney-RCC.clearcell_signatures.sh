...
Rscript --vanilla 3_analysis/posterior_predictive_checks.R --files_posteriors '../data/inference/Kidney-RCC.clearcell_signatures_20000_LNMROO.RData ../data/inference/Kidney-RCC.clearcell_signatures_ROO.RData ../data/inference/Kidney-RCC.clearcell_signatures_20000_DMROO.RData ../data/inference/Kidney-RCC.clearcell_signatures_20000_MROO.RData'
