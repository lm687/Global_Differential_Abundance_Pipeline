...
Rscript --vanilla 3_analysis/posterior_predictive_checks.R --files_posteriors '../data/inference/Breast-LobularCA_signatures_20000_LNMROO.RData ../data/inference/Breast-LobularCA_signatures_ROO.RData ../data/inference/Breast-LobularCA_signatures_20000_MROO.RData ../data/inference/Breast-LobularCA_signatures_20000_DMROO.RData'
